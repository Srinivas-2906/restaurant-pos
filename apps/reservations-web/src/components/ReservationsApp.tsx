...
import { isOnLocalDay, localDateIso } from "@/lib/dates";
import type { FloorPlan, Reservation, TabId, WaitlistEntry } from "@/lib/types";
  ...
  if (!outletId) {
    return (
      <div className="p-8 text-center space-y-4">
        <p className="text-slate-600">Select an outlet to view reservations.</p>
        <OutletSelector onChange={(id) => setOutletId(id)} />
      </div>
    );
  }
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-violet-600 text-white rounded-xl text-sm font-semibold hover:bg-violet-500"
          >
